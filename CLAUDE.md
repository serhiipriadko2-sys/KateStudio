...
- **Stack**: React 19, Vite 6, TypeScript 5.8, Tailwind CSS, Supabase (Auth, DB,
...
- `supabase gen types typescript --local > shared/types/supabase.ts` - Update
  types

## Architecture Highlights

- **AI**: Gemini integration via `gemini-proxy` Edge Function only. No client
  keys.
