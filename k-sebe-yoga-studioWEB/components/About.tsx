          ...
          <FadeIn delay={0} direction="right">
            ...
            <div className="relative w-full aspect-[3/4] rounded-[3rem] overflow-hidden shadow-xl">
              <Image
                ...
                alt="Преподаватель студии йоги К себе"
        ...
        <div className="md:w-7/12 md:pl-10 text-center md:text-left">
          ...
          <FadeIn delay={400}>
            <div className="space-y-6 text-brand-text/80 text-lg md:text-xl font-light leading-relaxed">
              <p>
                Преподаватели студии бережно ведут практики{' '}
              ...
              <p>
                Каждое занятие становится путешествием в глубину внутреннего покоя, туда, где живет
                гармония с собой и своим телом.
              </p>
              <p>
                Для нас йога — это не просто асаны. Это умение чувствовать себя в моменте и мягкая
