            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <FadeIn delay={100} fullWidth>
                <div className="relative group">
                  ...
                  <input 
                    ...
                    `}
                  />
                  {touched.name && !isNameValid && <span className="absolute right-4 top-4 text-rose-500"><AlertCircle className="w-5 h-5" /></span>}
                </div>
              </FadeIn>
              <FadeIn delay={200} fullWidth>
                <div className="relative group">
                  ...
                  <input 
                    ...
                    `}
                  />
                   {touched.phone && !isPhoneValid && <span className="absolute right-4 top-4 text-rose-500"><AlertCircle className="w-5 h-5" /></span>}
                </div>
              </FadeIn>
              <FadeIn delay={300} fullWidth>
                <div className="relative">
                  <label htmlFor="message" className="sr-only">Ваш вопрос</label>
                  <textarea 
                    id="message"
                    rows={2} 
                    name="message"
              ...
              <FadeIn delay={400} fullWidth>
                ...
                >
                  ...
                  {status === 'success' && <><CheckCircle className="w-5 h-5" /> Отправлено</>}
                  {status === 'error' && <><AlertCircle className="w-5 h-5" /> Ошибка. Повторить?</>}
