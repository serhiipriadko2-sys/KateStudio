...
drop policy if exists api_logs_insert_service on public.api_logs;
...
create index if not exists idx_ai_jobs_prompt_request_id on public.ai_jobs (prompt_request_id);
create index if not exists idx_api_logs_prompt_request_id on public.api_logs (prompt_request_id);
...
create index if not exists idx_prompt_requests_model_id on public.prompt_requests (model_id);
