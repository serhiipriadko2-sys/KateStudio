...
export const Logo: React.FC<LogoProps> = ({ 
  ...
  const groupStyle = isIgnited ? {
    filter: 'url(#neon-glow) drop-shadow(0 0 10px #fff) drop-shadow(0 0 20px ' + strokeColor + ')',
          ...
          {variant === 'full' && (
            <>
              ...
              <g transform="translate(0, 40)" strokeWidth="5"> 
                {/* К */}
                <path d="M 85 300 V 360 M 85 330 L 115 300 M 85 330 L 115 360" strokeDasharray={140} strokeDashoffset={140 * (1 - p)}/>
                {/* с */}
                <path d="M 160 330 A 15 15 0 1 0 160 360" strokeDasharray={80} strokeDashoffset={80 * (1 - p)}/>
                {/* е */}
                <path d="M 180 345 H 200 A 10 10 0 0 0 190 330 A 10 10 0 0 0 180 345 A 10 10 0 0 0 190 360 H 200" strokeDasharray={100} strokeDashoffset={100 * (1 - p)}/>
                {/* б */}
                <path d="M 230 310 H 245 M 230 310 V 345 A 15 15 0 1 0 245 345 V 345" strokeDasharray={120} strokeDashoffset={120 * (1 - p)}/>
                {/* е */}
                <path d="M 270 345 H 290 A 10 10 0 0 0 280 330 A 10 10 0 0 0 270 345 A 10 10 0 0 0 280 360 H 290" strokeDasharray={100} strokeDashoffset={100 * (1 - p)}/>
              </g>
