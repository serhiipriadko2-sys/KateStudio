            ...
            {isLiveMode ? (
              <div className="flex-1 bg-gradient-to-b from-stone-50 to-white flex flex-col items-center justify-center text-center p-8 relative overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                  ...
                  ></div>
                  {isLiveConnected && (
                    <div className="absolute w-full h-full bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-brand-mint/20 via-transparent to-transparent animate-pulse"></div>
                  )}
                </div>
