import { FadeIn, Marquee } from '@ksebe/shared';
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 text-center relative z-10">
        ...
        <FadeIn delay={200}>
          <h2 className="text-4xl md:text-6xl font-serif text-brand-text leading-[1.15] mb-8">
            ...
            кем ты{' '}
            <span className="text-brand-green italic font-normal relative inline-block">
              становишься
              <svg
                className="absolute -bottom-2 left-0 w-full h-2 text-brand-green/20"
                viewBox="0 0 100 10"
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 text-center relative z-10">
        <FadeIn delay={300}>
          <h2 className="text-4xl md:text-6xl font-serif text-brand-text leading-[1.15] mb-12">
            Это то, кто ты{' '}
            <span className="text-brand-green italic font-normal border-b-2 border-brand-green/30 pb-1">
              есть
            </span>
            .
          </h2>
        ...
        <FadeIn delay={400}>
          <p className="text-stone-500 text-lg md:text-xl font-light leading-relaxed max-w-2xl mx-auto mb-16">
            Мы создали пространство, где нет конкуренции и достигаторства. Только твое дыхание, твой
            ритм и безопасное возвращение к самому себе через осознанное движение.
          </p>
        </FadeIn>
