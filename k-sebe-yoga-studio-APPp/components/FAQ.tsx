...
const faqData = [
  {
    ...
    answer:
      'Приходите на любое групповое занятие! Все практики адаптированы для начинающих. Преподаватель поможет с техникой и предложит упрощённые варианты асан.',
  },
  {
    question: 'Нужна ли специальная подготовка?',
    answer:
      'Нет, специальная подготовка не требуется. Достаточно желания и удобной одежды. Мы работаем с любым уровнем физической формы.',
  },
  {
    question: 'Что обязательно нужно взять с собой?',
    answer:
      'Возьмите удобную одежду, в которой комфортно двигаться. Коврики есть в студии. Рекомендуем не есть плотно за 2 часа до практики.',
  },
  {
    question: 'Сколько времени длятся занятия?',
    answer:
      'Групповые занятия длятся 1 час. Индивидуальные тренировки — по договорённости, обычно от 60 до 90 минут.',
  },
];
