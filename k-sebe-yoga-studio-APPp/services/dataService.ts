...
export const dataService = {
  ...
  getClassesForDate: async (date: Date, type: 'offline' | 'online'): Promise<ClassSession[]> => {
    ...
    const templates = type === 'offline' ? [
        { name: "Inside Flow", time: "09:00", duration: "90 мин", spots: 12, loc: "Зал на Мира", int: 3, price: 800 },
        { name: "Хатха Йога", time: "18:30", duration: "60 мин", spots: 15, loc: "Зал на Ленина", int: 2, price: 700 },
        { name: "Медитация + Sound Healing", time: "20:00", duration: "60 мин", spots: 10, loc: "Зал на Мира", int: 1, price: 1000 },
        { name: "Vinyasa Flow", time: "12:00", duration: "75 мин", spots: 12, loc: "Зал на Ленина", int: 3, price: 800 },
    ] : [
        { name: "Утренний поток (Zoom)", time: "08:00", duration: "45 мин", spots: 50, loc: "Online", int: 2, price: 400 },
        { name: "Вечерняя растяжка (Zoom)", time: "19:00", duration: "60 мин", spots: 50, loc: "Online", int: 1, price: 400 }
    ];
